        ...
        <div className='container-fluid'>
          <div className='row'>
            ...
            <div className='box right'>
              <ul>
                <li><a href='http://twitter.com/ndlibraries' target='_blank'><img src='https://resources.library.nd.edu/frame/images/twitter.png' alt='Twitter' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NDLibraries</a></li>
                <li><a href='https://www.facebook.com/ndlibraries/' target='_blank'><img src='https://resources.library.nd.edu/frame/images/facebook.png' alt='Facebook' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NDLibraries</a></li>
              </ul>
            </div>
          </div>
        </div>
